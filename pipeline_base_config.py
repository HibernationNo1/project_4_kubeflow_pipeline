BASE_IMG = dict(
    record = "localhost:5000/pipeline:0.6",
    train = "localhost:5000/pipeline:0.6",
    evaluate = "localhost:5000/pipeline:0.6",
    test = "localhost:5000/pipeline:0.6"
    )
...
"""
docker build docker --no-cache -t localhost:5000/pipeline:0.6
