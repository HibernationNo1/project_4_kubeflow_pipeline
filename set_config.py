...
def set_config(args: dict, config_path: OutputPath("dict"), ) :
    ...
    if args['pipeline_name'] is not None : cfg.pipeline.pipeline_name = args['pipeline_name']
    if args['pipeline_version'] is not None : cfg.pipeline.pipeline_version = args['pipeline_version']
    ...
    if args['mode'] == "record":
        ...
        if args['dataset_vers'] is not None : cfg.gs.recoded_dataset_version = args['dataset_vers']
