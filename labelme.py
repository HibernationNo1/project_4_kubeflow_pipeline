...
def lebelme(cfg_path: InputPath("dict"), input_ann : dict, 
             train_dataset_path: OutputPath("dict"), val_dataset_path: OutputPath("dict")):   
    ...
    class labelme_custom():
        ...
        """
        def __init__(self, cfg, input_ann):
            self.cfg = cfg
            self.input_ann = input_ann
        ...
        def data_transfer(self):
            labelme_json_list = self.input_ann
    ...
    train_dataset, val_dataset = labelme_custom(cfg_dict, input_ann)
    
    json.dumps(train_dataset, open(train_dataset_path, "w"), indent=4, cls = NpEncoder)
    json.dumps(val_dataset, open(val_dataset_path, "w"), indent=4, cls = NpEncoder)
